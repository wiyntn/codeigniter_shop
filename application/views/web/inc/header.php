...
<body>
    <div class="wrap">
        <div class="header_top">
            <div class="logo">
                <a href="<?php echo base_url('/'); ?>"><img src="<?php echo base_url('uploads/'); ?><?php echo get_option('site_logo'); ?>" alt="" />
                   <!--  <img src="<?php echo base_url('uploads/'); ?><?php echo get_option('site_favicon'); ?>" alt="" /> -->
                </a>
            </div>
            <div class="header_top_right">
                ...
                if ($customer_id) {
                    ...
                    <h2><?php echo $this->session->userdata('customer_email') ?></h2>
                <?php } else {
                    ?>
